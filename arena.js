/* Territory G12 loader — mobile full-canvas framing */
(function(){
"use strict";
...
.then(function(){return load("mobile-layout-fix.js?v=1");})
.catch(function(err){console.error("Territory G12 loader:",err);});
})();