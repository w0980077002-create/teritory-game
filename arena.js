/* Stable tactical combat core. Multiplayer lobby/network layer is intentionally not mixed into this clean frontend base. */
...
document.getElementById('arenaModal')?.addEventListener('click',e=>{
  if(e.target.id==='arenaModal'){window.closeArenaModal();if(typeof showScreen==='function') showScreen('home');}
});
