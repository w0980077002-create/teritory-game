...
function useSlot(slot){
  ...
  if(slot==='adrenaline'&&battle.mode!=='1v1'){c[slot]--;battle.logs.push('⚡ Адреналин: выбранный союзник возвращается в бой.');performTeamUtility('Адреналин',()=>{});save();return}
}
