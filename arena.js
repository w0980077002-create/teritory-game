/* Territory G41 — Arena loader with cache-busted v141 assets. */
(function(){
  "use strict";
  const files=[
    "arena-core.js?v=141",
  ...
  loadCss('arena.css?v=141').then(()=>files.reduce((p,f)=>p.then(()=>loadScript(f)),Promise.resolve())).catch(e=>console.error('Territory G41 load error',e));
})();
