...
(()=>{
 ...
 function startFight(i){
  ...
  battle={enemy:{...src,maxHp:src.hp,hp:src.hp},turn:'player',round:1,attack:null,defense:[],enemyAttack:null,enemyDefense:[],log:['⚔️ Бой начался. Выбери атаку и две защиты.'],playerHp:Number(state.hp||hpMax()),playerMax:hpMax(),energySpent:0,auto:false,locked:false,anim:'',result:null}; render();
 }
