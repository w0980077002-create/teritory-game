...
Also replace the entire the Arena image files with the included folder contents.
...
4. Arena uses the approved player/opponent artwork from the root directory.
