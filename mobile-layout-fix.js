/* Territory G23 — restore tested side-button alignment */
(function(){
"use strict";

function addStyle(){
  if(document.getElementById("territoryG23Style")) return;
  var s=document.createElement("style");
  s.id="territoryG23Style";
  s.textContent=`
...
function install(){
  ...
  if(!home || home.dataset.g23==="1") return;
  home.dataset.g23="1";
